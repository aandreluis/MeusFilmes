<title>MeusFilmes - Paginação TESTE</title>
<?php 
    include("header.php"); 
    include("conecta.php");
            ...
            <div class="resultado"><!-- Exibe os resultados da pesquisa por jquery --></div>
                ...
                <nav id="pags" aria-label="Página listar filmes">
                    <ul class="pagination justify-content-center">
                        <li class="page-item"><a class="page-link" href="paginacao.php?p=1">Início</a></li>
                <?php
                ...
                ?>
                <li class="page-item active"><a class="page-link" href="paginacao.php?p=<?php echo $p;?>"><?php echo $p;?></a></li>
                <?php
                ...
                ?>
                    <li class="page-item"><a class="page-link" href="paginacao.php?p=<?php echo $pags;?>">Fim</a></li>
                </nav>  
